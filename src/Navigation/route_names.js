module.exports = {
  ...
  DEVICE_AUTH: {
    ...
    proceed_to_register: 'DEVICE_AUTH_proceed_to_register',
    proceed_to_forgot_password: 'DEVICE_AUTH_proceed_to_forgot_password',
    proceed_to_verify_otp: 'DEVICE_AUTH_proceed_to_verify_otp',
    splash: 'DEVICE_AUTH_splash',
    device_sync: 'DEVICE_OAUTH_device_sync',
    oauth_view: 'DEVICE_OAUTH_oauth_view',
  },
  ...
  DASHBOARD_NAVIGATION: {
    ...
    app_notification_list: 'DASHBOARD_NAVIGATION_app_notification_list',
    app_report_generation: 'DASHBOARD_NAVIGATION_app_report_generation',
  },
  ADVANCE_PAY_NAVIGATION: {
    proceed_to_req_advance_pay: 'DEVICE_AUTH_proceed_to_req_advance_pay',
    my_advance_pay_list: 'DEVICE_AUTH_my_advance_pay_list',
    proceed_to_pay_advance: 'ADVANCE_PAY_NAVIGATION_proceed_to_pay_advance',
    proceed_to_check_pending_advance:
      'ADVANCE_PAY_NAVIGATION_proceed_to_check_pending_advance',
  },
  CONNECTED_APPS: {
    list_of_apps: 'CONNECTED_APPS_list_of_apps',
  },
};
